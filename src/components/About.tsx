...
export default function About() {
    return (
        <section className="bg-[#f4f1e8] text-gray-800 min-h-[75vh] p-3 flex justify-center items-center" id="about">
            <div className="container grid gap-6 mx-auto lg:grid-cols-2 xl:grid-cols-5">
                ...
                <div className="relative w-full xl:col-span-2 p-3">
                    <Image 
                        src="/assets/About/imagem2.jpg" 
                        alt="Limpeza Profissional" 
                        className="object-cover w-[35vh] h-[60vh] md:w-3/4 md:h-[500px] rounded-t-full xl:rounded-b-none bg-gray-500" 
                        width={800} 
                        height={500}
                    />
                </div>
