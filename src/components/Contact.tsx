...
export default function Contact(){
    return (
        ...
        <section className="py-3 bg-[#ADC5B4] text-gray-900" id="contact">
            <div className="grid max-w-6xl grid-cols-1 px-3 mx-auto lg:px-8 md:grid-cols-2 md:divide-x md:pt-20 mb-20">

                <div>
                    <div className="py-6 md:py-0 md:px-6 flex flex-col justify-center p-5 md:p-0">
                    ...
                    <div className="py-6 md:py-0 md:px-6 flex flex-col justify-center p-5 md:p-0">
                        ...
                        <h1 className="text-4xl md:text-3xl font-bold text-white mb-5 radley-regular-italic">Dados para contato</h1>
                            ...
                            <p className="flex items-center mb-3 text-gray-700">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-8 h-8 mr-2 sm:mr-6 text-[#314027]">
                            ...
                            <div className="flex flex-col justify-start lg:pt-5">
                                <div className="flex space-x-4">
                                    ...
                                    */}
                                    ...
                                    {/*
                                    <a href="https://www.instagram.com/cacaulovers" target="_blank" title="Instagram" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-[#9b4819] hover:bg-gray-50 text-gray-50 hover:text-[#9b4819] focus:ring hover:ring focus:ring-opacity-75 focus:ring-[#9b4819] hover:ring-[#9b4819]">
                                        <FaInstagram className="h-4 w-4 md:h-6 md:w-6" />
                                    </a>
                                    */}
                                    
                                    {/* <a href="mailto:contato@cacaushow.com.br" title="Email" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-[#9b4819] hover:bg-gray-50 text-gray-50 hover:text-[#9b4819] focus:ring hover:ring focus:ring-opacity-75 focus:ring-[#9b4819] hover:ring-[#9b4819]">
                                        <FaEnvelope className="h-4 w-4 md:h-6 md:w-6" />
                                    </a>
                                    */}
                                    
                                    {/* <a href="tel:+5511999999999" title="Telefone" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-[#9b4819] hover:bg-gray-50 text-gray-50 hover:text-[#9b4819] focus:ring hover:ring focus:ring-opacity-75 focus:ring-[#9b4819] hover:ring-[#9b4819]">
                                        <FaPhone className="h-4 w-4 md:h-6 md:w-6" />
                                    </a>
                                    */}
                                    
                                    {/*
                                    <a href="tel:+5511999999999" title="WhatsApp" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-[#9b4819] hover:bg-gray-50 text-gray-50 hover:text-[#9b4819] focus:ring hover:ring focus:ring-opacity-75 focus:ring-[#9b4819] hover:ring-[#9b4819]">
                                        <FaWhatsapp className="h-4 w-4 md:h-6 md:w-6" />
                                    </a>
                                    */}
                                    
                                    {/*
                                    <a href="tel:+5511999999999" title="SMS" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-[#9b4819] hover:bg-gray-50 text-gray-50 hover:text-[#9b4819] focus:ring hover:ring focus:ring-opacity-75 focus:ring-[#9b4819] hover:ring-[#9b4819]">
                ...
                <form className="flex flex-col py-6 space-y-6 md:py-0 md:px-6 p-5 md:p-0">
                    ...
                    <button type="button" className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 bg-[#314027] text-white focus:ring-quinta hover:ring-[#f4f1e8] w-full">Enviar</button>
                </form>
