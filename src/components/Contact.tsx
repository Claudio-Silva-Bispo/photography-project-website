    ...
    return (
        ...
        <section className="py-3 bg-[#ADC5B4] text-gray-900" id="contact">
            <div className="grid max-w-6xl grid-cols-1 px-3 mx-auto lg:px-8 md:grid-cols-2 md:divide-x md:pt-20">
                ...
                <div>
                    <div className="py-6 md:py-0 md:px-6 flex flex-col justify-center p-2 md:p-0">
                        <h1 className="text-5xl text-[#f4f1e8] radley-regular">Contato</h1>
                ...
                <div className="md:hidden py-6 md:py-0 md:px-6 flex-col justify-center p-2 md:p-0">
                        ...
                        <h1 className="text-4xl md:text-3xl font-bold text-[#f4f1e8] mb-5 radley-regular">Entre em contato</h1>

                            <p className="flex items-center mb-3 text-gray-700">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-8 h-8 mr-2 sm:mr-6 text-[#314027]">
                                    <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"></path>
                                </svg>
                                <span className='text-[#f4f1e8] carlito-regular'>Totem Lake Way, Kirkland</span>
                            </p>
                            <p className="flex items-center mb-3 text-gray-600">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-8 h-8 mr-2 sm:mr-6 text-[#314027]">
                                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path>
                                </svg>
                                <span className='text-[#f4f1e8] carlito-regular'>+ (425) 588-6654</span>
                            </p>
                            <p className="flex items-center mb-3 text-gray-600">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-8 h-8 mr-2 sm:mr-6 text-[#314027]">
                                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                                ...
                                <span className='text-[#f4f1e8] carlito-regular'>livehopephotografy@gmail.com</span>
                            </p>
